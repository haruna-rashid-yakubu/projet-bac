...
const InvoiceModal = () => {
  ...
  const userHashId = currentUser ? (
    <Fragment>
      Modifier <span style={{ color: "#7E88C3" }}>#</span>
      {currentUser.id}
    </Fragment>
  ) : null;
    ...
    <div id="invoice-modal" className="back-drop">
      <form onSubmit={onSubmit}>
        <div id="invoice-modal-form" className={dark ? "dark" : undefined}>
          ...
          <div id="ni-bill-from">
            <p className="modal-sec-title">Facture</p>
          ...
          <div id="ni-bill-to">
            <p className="modal-sec-title">Facture de : </p>
            <p className={dark ? "dark td-beautiful" : "td-beautiful"}>
              Nom du Client
            </p>
            <input
          ...
          <div id="ni-item-list">
            ...
            >
              <img
                ...
                alt="icon-plus"
              />
              <p style={{ marginLeft: "5px" }}>Ajouter un Article</p>
            </button>
          </div>
          <div id="alert-messages">
            {inputAlert ? (
              <div id="field-alert">
                <p className="alert-text">-Veuillez remplir toutes les cases</p>
              </div>
            ) : null}
            {itemAlert ? (
              <div id="item-alert">
                <p className="alert-text">-Ajouter au moins un article</p>
              </div>
            ) : null}
          </div>
        </div>
