          ...
          <div id='header-left'>
            ...
            {run && invoices ? (
              <Fragment>
                ...
                >
                  Il y'a au Total {numOfInvoices} {filterTypes}
                </p>
                <p
              ...
              <Fragment>
                <p id='header-noInvoices'>Total de 0 Factures</p>
                <p id='mobile-noInvoices'>Total de 0 Factures</p>
              </Fragment>
            ) : null}
          </div>
          <div id='header-right'>
            ...
            <button id='new-invoice-container' onClick={newInvoiceClick}>
              ...
              <p id='new-invoice-btn-words'>Nouvelle Facture</p>
              {/* Returns on mobile */}
              <p id='mobile-new-invoice-btn-words'>Nouvelle Facture</p>
            </button>
          </div>
        </header>
